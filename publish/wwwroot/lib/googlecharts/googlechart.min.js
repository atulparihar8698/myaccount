...
if (!window['google']['loader']) {
    ...
    (function () {
        ...
        google.load = function (a, b, c) {
            function d(g) { var k = g.split("."); if (2 < k.length) throw G("Module: '" + g + "' not found!"); "undefined" != typeof k[1] && (e = k[0], c.packages = c.packages || [], c.packages.push(k[1])) } var e = a; c = c || {}; if (a instanceof Array || a && "object" == typeof a && "function" == typeof a.join && "function" == typeof a.reverse) for (var f = 0; f < a.length; f++)d(a[f]); else d(a); if (a = J[":" + e]) {
            c && !c.language && c.locale && (c.language = c.locale); c && "string" == typeof c.callback && (f = c.callback, f.match(/^[[\]A-Za-z0-9._]+$/) && (f =
                window.eval(f), c.callback = f)); if ((f = c && null != c.callback) && !a.F(b)) throw G("Module: '" + e + "' must be loaded before DOM onLoad!"); f ? a.v(b, c) ? window.setTimeout(c.callback, 0) : a.load(b, c) : a.v(b, c) || a.load(b, c)
        ...
        google.loader.g = function (a, b, c) {
            if (null === l) b: { var d = h.document; if ((d = d.querySelector && d.querySelector("script[nonce]")) && (d = d.nonce || d.getAttribute("nonce")) && aa.test(d)) { l = d; break b } l = "" } d = l; if (c) {
                if ("script" == a) { var e = document.createElement("script"); e.type = "text/javascript"; e.src = b; d && e.setAttribute("nonce", d) } else "css" == a && (e = document.createElement("link"), e.type = "text/css", e.href = b, e.rel = "stylesheet"); (a = document.getElementsByTagName("head")[0]) || (a = document.body.parentNode.appendChild(document.createElement("head")));
                a.appendChild(e)
        ...
        }; m("google.loader.writeLoadTag", google.loader.g); google.loader.ea = function (a) { K = a }; m("google.loader.rfm", google.loader.ea);
        ...
        Q.prototype.load = function (a, b) {
            var c = this.I(b), d = b && null != b.callback; if (d) var e = new S(b.callback); for (var f = [], g = c.length - 1; 0 <= g; g--) { var k = c[g]; d && e.W(k); this.m[":" + k] ? (c.splice(g, 1), d && this.h[":" + k].push(e)) : f.push(k) } if (c.length) {
            b && b.packages && (b.packages = c.sort().join(",")); for (g = 0; g < f.length; g++)k = f[g], this.h[":" + k] = [], d && this.h[":" + k].push(e); if (b || null == K[":" + this.b] || null == K[":" + this.b].versions[":" + a] || google.loader.AdditionalParams || !this.u) b && b.autoloaded || google.loader.g("script", this.j(a,
...
google.load("visualization", "1.1", { "autoloaded": true, "packages": ["table", "corechart"] });
if (window['google'] != undefined && window['google']['loader'] != undefined) {
    if (!window['google']['visualization']) {
        window['google']['visualization'] = {};
        google.visualization.Version = '1.1';
        google.visualization.JSHash = '760702f7b56bd967c887f2c9118815e6';
        google.visualization.LoadArgs = 'file\x3dvisualization\x26v\x3d1.1\x26packages\x3dtable,corechart';
    }
    google.loader.writeLoadTag("css", google.loader.ServiceBase + "/api/visualization/1.1/760702f7b56bd967c887f2c9118815e6/ui+en,table+en.css", false);
    google.loader.writeLoadTag("script", google.loader.ServiceBase + "/api/visualization/1.1/760702f7b56bd967c887f2c9118815e6/webfontloader,format+en,default+en,ui+en,table+en,corechart+en.I.js", false);
}